...
const myProxies = [
  {
    //vless-reality-vision模板，修改自己节点配置
    name: "🇺🇸 Los Angeles",
    type: "vless",
    server: "12345.com",
    port: 443,
...
//  需要自动加入的分组名称
// ============================
const targetGroups = ["蓝胖云LanPangYun"];//[]内填入自己机场订阅名称
...
const ruleProviders = {
  ...
  "Customize": {
    ...ruleProviderCommon,
    "behavior": "classical",
    "url": "https://raw.githubusercontent.com/kzlong/Rules/main/Clash/Direct.yaml",
...
const rules = [
  ...
  "DOMAIN-SUFFIX,adobe.io,REJECT",//屏蔽adobe,让Photoshop等不弹窗
  "DOMAIN-SUFFIX,lcs-cops.adobe.io,DIRECT",//屏蔽adobe,让Photoshop等不弹窗，需要放行这个ip
  ...
  "RULE-SET,youtube,YouTube",  // 油管规则集
  ...
  "RULE-SET,Customize,DIRECT",   // 自定义直连网站
